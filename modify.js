...
const filePath = 'src/main/java/com/job/portal/service/CodeExecutionService.java';
let content = fs.readFileSync(filePath, 'utf-8');

const newExecute = `            if ("java".equalsIgnoreCase(language)) {
...
const oldClean = `            lastLine = line.replace("/app/main.py", "solution.py").replace("Main.java", "Solution.java").trim();`;
const newClean = `            lastLine = line.replace("/app/main.py", "solution.py")
...
content = content.replace("    private String extractCleanError(String output) {", jsCppMethods + "\n    private String extractCleanError(String output) {");
